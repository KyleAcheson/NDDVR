...
def run_2D_comparison(x, y, neig, plot=False):
    ...
    energies_100, wfs_100, H100 = sa.algorithm_100_2D(x, y, v, mass_x, mass_y, neig)
    ...
    energies_27, wfs_27, H27 = sa.algorithm_27_2D(x, y, v, mass_x, mass_y, neig)
    if plot:
        ...
        pltg.plot_wavefunctions_2d(x, y, wfs_27, energies_27, num_to_plot=neig, fname=f'A27_2DHO_Nxy{Nx}')

    return energies_dvr, energies_100, energies_36, energies_29, energies_27
    #return energies_dvr, energies_36
...
if __name__ == "__main__":
    ...
    x = np.linspace(-5, 5, Nx)
    y = np.linspace(-5, 5, Ny)
    edvr, e100, e36, e29, e27 = run_2D_comparison(x, y, neig, plot=True)
    #edvr, e36 = run_2D_comparison(x, y, neig, plot=True)
    print(edvr)
    print(e100)
    print(e36)
    print(e29)
